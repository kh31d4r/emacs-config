...
** Capture templates
   #+BEGIN_SRC emacs-lisp
     (setq org-capture-templates
           '(("t" "Todo" entry (file "~/org/life.org")
              "* TODO %?\n  :NOTES:\n  - Created: %t\n  :END:\n  %i\n")
             ("w" "Work Item" entry (file "~/org/work.org")
              "* TODO %?\n  :NOTES:\n  - Created: %t\n  :END:\n  %i\n")
             ("i" "Work List Item" entry (file "~/org/work.org")
              "* TODO %? [/]\n  :NOTES:\n  - Created: %t\n  :END:\n  - [ ] %i\n")
             ("b" "Book" entry (file+headline "~/org/life.org" "Books")
