     ...
     (setq org-capture-templates
           '(("l" "life")
             ("lt" "Todo" entry (file "~/org/life.org")
              (file "~/.emacs.d/capture-templates/life/todo"))
             ("lc" "Todo with checklist" entry (file "~/org/life.org")
              (file "~/.emacs.d/capture-templates/life/todo-checklist"))
             ...
             ("wt" "Todo" entry (file "~/org/work.org")
              (file "~/.emacs.d/capture-templates/work/todo"))
             ("wc" "Todo with checklist" entry (file "~/org/work.org")
              (file "~/.emacs.d/capture-templates/work/checklist"))))
   #+END_SRC
** Export
