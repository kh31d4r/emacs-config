...
** System
   ...
   #+BEGIN_SRC emacs-lisp
     (let ((autosave (expand-file-name "autosave" user-emacs-directory)))
       (setq auto-save-list-file-name autosave)
...
* Mail
  ...
  [[https://github.com/djcb/mu][source]]. The =smtp_settings.el= file need to set the following
  variables:
  ...
  - =n= to compose new mail
  - =o= to compose new =org-mode= mail
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package mu4e
      ...
      (global-set-key (kbd "C-c m n") 'mu4e-compose-new))
